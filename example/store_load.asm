...
next_round:
    ...
    mb     ;--- 强制内存同步等待: 确保 Cpu0/Cpu1 能看到正确的 a=0 和 b = 0
    SUB    R2           R2           1            ; R2 = R2 - 1
	JMP    cpu2_proc                              ; 继续测试
